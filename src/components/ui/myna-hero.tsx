        ...
        <div className="flex h-16 items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-mono text-xl font-bold">Falzin</span>
            </div>
          </a>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navigationItems.map((item) => (
              <a
                key={item.title}
                href={item.href}
                className="text-sm font-mono text-foreground hover:text-[#F68048] transition-colors"
              >
                {item.title}
              </a>
            ))}
          ...
          <div className="flex items-center space-x-4">
            <Button
              variant="default"
              className="rounded-none hidden md:inline-flex bg-[#F68048] hover:bg-[#F68048]/90 font-mono"
            >
            ...
            <Sheet>
              ...
              <SheetContent>
                <nav className="flex flex-col gap-6 mt-6">
                  ...
                  <Button className="cursor-pointer rounded-none bg-[#F68048] hover:bg-[#F68048]/90 font-mono">
                    GET STARTED <ArrowRight className="ml-1 w-4 h-4" />
                  </Button>
                </nav>
              </SheetContent>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              {labels.map((feature, index) => (
                ...
                >
                  <feature.icon className="h-5 w-5 text-[#F68048]" />
            ...
            >
              <Button
                size="lg"
                className="cursor-pointer rounded-none mt-12 bg-[#F68048] hover:bg-[#F68048]/90 font-mono"
              >
                GET STARTED <ArrowRight className="ml-1 w-4 h-4" />
              </Button>
            </motion.div>
        ...
        <section className="container" ref={ref}>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className="mb-6 rounded-full bg-[#F68048]/10 p-4">
                  <feature.icon className="h-8 w-8 text-[#F68048]" />
                </div>
